...
List topCompanies=[
  ...
  TopCompanies(logo: NetworkImage("https://designermag.org/wp-content/uploads/2013/10/TransparencyLogo-Design.jpg",scale: 5),location: "London",name: "Transify"),
  TopCompanies(logo: NetworkImage("https://upload.wikimedia.org/wikipedia/commons/5/53/Wikimedia-logo.png",scale: 5),location: "Sudan",name: "CRAW Dev"),
